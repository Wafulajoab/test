...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<tr><th style='background-color: #f2f2f2; border: 1px solid black; text-align: left; padding: 8px;'>job_title</th><th style='background-color: #f2f2f2; border: 1px solid black; text-align: left; padding: 8px;'>interview_date</th><th style='background-color: #f2f2f2; border: 1px solid black; text-align: left; padding: 8px;'>interview_time</th><th style='background-color: #f2f2f2; border: 1px solid black; text-align: left; padding: 8px;'>Action</th></tr>";
    
    // Fetch and display data row by row
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>";
        echo "<td style='border: 1px solid black; text-align: left; padding: 8px;'>" . $row['job_title'] . "</td>";
        echo "<td style='border: 1px solid black; text-align: left; padding: 8px;'>" . $row['interview_date'] . "</td>";
        echo "<td style='border: 1px solid black; text-align: left; padding: 8px;'>" . $row['interview_time'] . "</td>";
        echo "<td style='border: 1px solid black; text-align: left; padding: 8px;'><a href='edit_schedule.php?id=" . $row['id'] . "' style='text-decoration: none; color: blue;'>Edit</a> | <a href='delete_schedule.php?id=" . $row['id'] . "' onclick=\"return confirm('Are you sure you want to delete this job?')\" style='text-decoration: none; color: red;'>Delete</a></td>"; // Edit and delete links
        echo "</tr>";
    }
    echo "</table>";
    echo "<br>"; // Add spacing
    echo "<button style='background-color: #4CAF50; color: white; padding: 12px 20px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px; margin-bottom: 20px;'><a href='admin_post_interviews.php' style='text-decoration: none; color: white;'>Add New Schedule</a></button><br><br>"; // Button link to add new job form
} else {
