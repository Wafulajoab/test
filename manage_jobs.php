...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td style='border: 1px solid black; text-align: left; padding: 8px;'>" . $row['job_limit'] . "</td>";
        ...
        echo "<td style='border: 1px solid black; text-align: left; padding: 8px;'><a href='edit_job.php?id=" . $row['id'] . "' style='text-decoration: none; color: blue;'>Edit</a> | <a href='delete_job.php?id=" . $row['id'] . "' onclick=\"return confirm('Are you sure you want to delete this job?')\" style='text-decoration: none; color: red;'>Delete</a></td>"; // Edit and delete links
        echo "</tr>";
    }
    echo "</table>";
    echo "<br>"; // Add spacing
    echo "<button style='background-color: #4CAF50; color: white; padding: 12px 20px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px; margin-bottom: 20px;'><a href='jobs.php' style='text-decoration: none; color: white;'>Add New Job</a></button><br><br>"; // Button link to add new job form
} else {
    echo "No jobs found.";
}
