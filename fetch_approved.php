...
// Query to fetch approved applicants' usernames, emails, and phone numbers
$sql = "SELECT user_name, email, phone FROM Applications WHERE status = 'approved'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<th style='border: 1px solid black; padding: 8px; text-align: left;'>Username</th>";
    echo "<th style='border: 1px solid black; padding: 8px; text-align: left;'>Email</th>";
    echo "<th style='border: 1px solid black; padding: 8px; text-align: left;'>Phone</th>";
    echo "</tr>";
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr style='border: 1px solid black;'>";
        echo "<td style='border: 1px solid black; padding: 8px; text-align: left;'>" . $row["user_name"] . "</td>";
        echo "<td style='border: 1px solid black; padding: 8px; text-align: left;'>" . $row["email"] . "</td>";
        echo "<td style='border: 1px solid black; padding: 8px; text-align: left;'>" . $row["phone"] . "</td>";
        echo "</tr>";
    }
    echo "</table>";
} else {
